...
function TermsAndConditions() {
  return (
    <>
      ...
      <Container class1="terms-conditions-wrapper py-5  home-wrapper-2">
        <div className="row">
              ...
              <div>
                <div>
                  ...
                  <p>
                    ...
                    logistics costs. Please check your order summary to
                    understand the delivery charges for individual products. For
                    Products listed as Flipkart Plus, a Rs 40 charge for
